    ...
    window.recherche = new Vue({
        ...
        methods: {
            ...
            searchByService: function () {
                $.post(Routing.generate("searchEssais", {query: this.essai.query}), {
                    filters: {
                        'statut': 'Inclusions ouvertes',
            ...
            linkVisite: function (visite) {
                return Routing.generate("patient", {
                    "id": visite.inclusion.patient.id,
                    "id_inclusion": visite.inclusion.id
                });
            },
            dayAfter: function () {
        ...
        computed: {
            patientsFiltered: function () {
                if (this.patient.orderKey == "datNai") {
                    var dates = _.sortBy(this.patient.results, [function (o) {
                        return o.datNai.date;
                    }]);
            ...
            inclusionsFiltered: function () {
                if (this.inclusion.orderKey == "datInc") {
                    ...
                    var patients = _.sortBy(this.inclusion.results, [function (o) {
                    ...
                    var essais = _.sortBy(this.inclusion.results, [function (o) {
                        return o.essai.nom;
                    }]);
                    if (this.inclusion.order[this.inclusion.orderKey] == "asc") {
                        return essais;
            ...
            annuairesFiltered: function () {
                if (this.annuaire.orderKey == "essai") {
                    var essais = _.sortBy(this.annuaire.results, [function (o) {
                        return o.essai.nom;
                    }]);
            ...
            visitesFiltered: function () {
                if (this.visite.orderKey == "date") {
                    ...
                    var patients = _.sortBy(this.visite.results, [function (o) {
                        return o.inclusion.patient.nom;
                    }]);
                    if (this.visite.order[this.visite.orderKey] == "asc") {
                        return patients;
                    } else {
